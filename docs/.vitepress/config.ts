		...
		nav: [
			...
			},
			{
				...
				items: [
					...
					{ text: 'Bean', link: '/spring-boot/bean' },
					{ text: '事务管理', link: '/spring-boot/transaction' },
					{ text: '配置与属性', link: '/spring-boot/config' },
					{ text: '校验', link: '/spring-boot/validation' },
					{ text: '自定义 Starter', link: '/spring-boot/custom-starter' },
			...
			},
			{
				...
				items: [
					...
					{ text: 'SpringDoc', link: '/dev-tools/springdoc' },
					{ text: 'Hutool', link: '/dev-tools/hutool' },
					{ text: 'Netty', link: '/dev-tools/netty' },
		...
		sidebar: {
			'/cola/': [
				...
				},
				{
					text: '参考资料',
					collapsed: false,
					items: [{ text: '注解速查手册', link: '/cola/annotations' }],
				},
			],
			'/redis/': [
				{
			...
			'/mysql/': [
				...
				},
				{
					text: '连接池',
					collapsed: false,
					items: [{ text: 'Druid 连接池', link: '/mysql/druid' }],
				},
				{
					text: 'ORM 框架',
					collapsed: false,
