...
本指南基于 **COLA 5.0.0 + Spring Boot 3.x** 版本编写。

### Spring Boot 版本说明

| COLA 版本 | Spring Boot 版本 | 命名空间 | JDK 要求 | 状态 |
|------|------|------|------|------|
| **5.0.0** | **3.x** | `jakarta.*` | **JDK 17+** | ✅ 当前版本 |
| 4.x | 2.7.x | `javax.*` | JDK 8+ | 历史版本 |

**注意**：COLA 5.0.0 使用 JDK 17 编译，不支持 JDK 8。如需在 Spring Boot 2.7.x 环境下使用，请选择 COLA 4.x 版本。

如果你从 COLA 4.x 升级到 5.0.0，需要注意：
